...
if TaskParameters.GUI.EarlyWithdrEndsTrial
    sma = AddState(sma, 'Name', 'Lin',...
        'Timer', TaskParameters.GUI.FeedbackTime,...
        'StateChangeConditions', {LeftPortOut, 'ITI','Tup','stillLin'},...
        'OutputActions', {});
else
    sma = AddState(sma, 'Name', 'Lin',...
        'Timer', TaskParameters.GUI.FeedbackTime,...
        'StateChangeConditions', {LeftPortOut, 'wait_Sin','Tup','stillLin'},...
        'OutputActions', {});
end
...
if TaskParameters.GUI.EarlyWithdrEndsTrial
    sma = AddState(sma, 'Name', 'Rin',...
        'Timer', TaskParameters.GUI.FeedbackTime,...
        'StateChangeConditions', {RightPortOut, 'ITI','Tup','stillRin'},...
        'OutputActions', {});
else
    sma = AddState(sma, 'Name', 'Rin',...
        'Timer', TaskParameters.GUI.FeedbackTime,...
        'StateChangeConditions', {RightPortOut, 'wait_Sin','Tup','stillRin'},...
        'OutputActions', {});
end
